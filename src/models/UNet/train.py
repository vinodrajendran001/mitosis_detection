...
dir_img_t = Path('/data1/vinod/mitosis/data/processed/train/input')
dir_mask_t = Path('/data1/vinod/mitosis/data/processed/train/output')
dir_img_v = Path('/data1/vinod/mitosis/data/processed/val/input')
dir_mask_v = Path('/data1/vinod/mitosis/data/processed/val/output')
...
def train_model(
    ...
    # 1. Create dataset
    train_dataset = MitosisDataset(dir_img_t, dir_mask_t, img_size)
    val_dataset = MitosisDataset(dir_img_v, dir_mask_v, img_size)
